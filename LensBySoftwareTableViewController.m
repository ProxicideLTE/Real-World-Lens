//
//  LensBySoftwareTableViewController.m
//  LensLookupTable
//
...
@implementation LensBySoftwareTableViewController
...
- (void) parseContent {
    ...
    NSString* path = [[NSBundle mainBundle] pathForResource:@"lens_by_software" ofType:@"xml"];
        ...
        while (true) {
            ...
            switch (xmlTextReaderNodeType(reader)) {
                ...
                case XML_READER_TYPE_TEXT:
                    ...
                    if ([currentTagName isEqualToString:@"name"] && [currentTagValue isEqualToString:softwareName]) {
                        foundSoftware = YES;
                        break;
                    }
                    
                    // If the software is found and the the current tag is the supported software.
                    else if (foundSoftware && [currentTagName isEqualToString:@"supported_lens_type"]) {
                    ...
                    else if (foundSoftware && [currentTagName isEqualToString:@"end"]) {
                        foundSoftware = NO;
                        break;
                    }
...
- (IBAction) backBtnUserClick:(id)sender {
    ...
    // View to go back to.
    SoftwareView* table = [SoftwareView alloc];
    AppNavigationController* view = [[AppNavigationController alloc] initWithRootViewController:table];
